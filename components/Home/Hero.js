  ...
  return (
    ...
    <div className="bg-gradient-to-r from-red-400 to-cyan-400">
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-24">
        ...
        <div className="w-full max-w-md px-3 py-4 md:px-10 z-10">
        <Tab.Group>
      ...
      <Tab.Panels>
        <Tab.Panel>
           <div className="flex flex-col lg:flex-row gap-3 lg:gap-5 flex-wrap lg:flex-nowrap items-center py-5">
